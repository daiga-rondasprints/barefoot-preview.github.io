...
var EXCURSION_NAME = 'Sigulda, Cēsis & Gauja Valley';
var BOKUN_WORKER_URL = 'https://bokun-availability.daiga.workers.dev';
var BOKUN_ACTIVITY_ID = '1212740';
...
function bkGenerateRef() {
  ...
  var prefix = bkIsTestMode() ? 'TEST-' : 'BSC-';
...
async function bkCallPayLater(chipText) {
  ...
  var waMsg = 'Hi Daiga! I\u2019ve just reserved seats for the Sigulda, C\u0113sis & Gauja Valley excursion \u2014 looking forward to it!\n\n'
...
function bkSendBankConfirmWA() {
  ...
  var msg = 'Hi Daiga!\n\nI have made a bank transfer for the Sigulda, C\u0113sis & Gauja Valley excursion.\n\n'
    + 'Reference: ' + bkState.ref + '\n'
    + 'Date: ' + bkFormatDate(bkState.date) + '\n'
    + 'Adults: ' + bkState.adults + '\n'
    + (bkState.children > 0 ? 'Children: ' + bkState.children + '\n' : '')
  ...
  setTimeout(function() {
    window.location.href = '../thank-you.html'
      ...
      + '&exc=sigulda&adults=' + bkState.adults
      + '&children=' + bkState.children
      + '&total='    + total
      + '&method=bank'
...
function bkSendRevolutWA() {
  ...
  var msg = 'Hi Daiga!\n\nI\'d like to pay via Revolut for the Sigulda, C\u0113sis & Gauja Valley excursion.\n\n'
    + 'Reference: ' + bkState.ref + '\n'
    + 'Date: ' + bkFormatDate(bkState.date) + '\n'
    + 'Adults: ' + bkState.adults + '\n'
    + (bkState.children > 0 ? 'Children: ' + bkState.children + '\n' : '')
...
function buildInquiryEmail() {
  return {
    subject: 'Question about Sigulda, Cēsis & Gauja Valley excursion',
    body: 'Hi Daiga,\n\nI\'m interested in the Sigulda, Cēsis & the Gauja Valley excursion and have a few questions before booking.\n\n[Your questions here]\n\nThank you!'
  };
}
...
function buildBookingEmail() {
  ...
  return {
    subject: 'Revolut payment request — Sigulda, Cēsis & Gauja Valley excursion ' + fmtDate,
    body: 'Hi Daiga,\n\nI\'d like to pay via Revolut for the Sigulda, Cēsis & Gauja Valley excursion.\n\n'
      + 'Reference: ' + bkState.ref + '\n'
      + 'Date: ' + fmtDate + '\n'
      + 'Adults: ' + bkState.adults + '\n'
...
function bkFireConversion(method, value, ref) {
  if (typeof gtag !== 'undefined') {
    ...
    gtag('event', ev, {
      ...
      items: [{ item_id:'sigulda-cesis-gauja', item_name:'Sigulda, C\u0113sis & the Gauja Valley',
...
document.querySelectorAll('.bk-pay-opt').forEach(function(opt) {
  opt.addEventListener('keydown', function(e) {
    if (e.key === 'Enter' || e.key === ' ') {
      e.preventDefault();
      var n = parseInt(opt.id.replace('bk-opt-', ''));
...
const lbPhotos = [
  {src:'https://barefootbaltic.com/images/exc-sigulda/turaida-castle-aerial-red-brick-latvia.jpg', cap:'Turaida Castle — the red-brick medieval fortress above the Gauja'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-castle-exterior-red-walls-latvia.jpg', cap:'Cēsis Castle — the Livonian Order seat in Vidzeme'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/gauja-river-bend-aerial-valley-latvia.jpg', cap:'The Gauja river bend, Gauja Valley National Park'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/sigulda-cable-car-gauja-valley-latvia.jpg', cap:'The Sigulda cable car across the Gauja valley cliffs'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesu-maize-baker-artisan-bread-latvia.jpg', cap:'The baker at Česu Maize, kneading traditional rye bread'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesu-maize-bakery-sign-artisan-bread-latvia.jpg', cap:'Česu Maize — local bread, baked right here'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesu-maize-guests-bakery-tasting-latvia.jpg', cap:'Guests tasting fresh bread at the bakery counter'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/turaida-castle-guests-exploring-latvia.jpg', cap:'Guests exploring the Turaida Castle grounds'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-castle-walls-autumn-latvia.jpg', cap:'Cēsis Castle walls framed by autumn leaves'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/gauja-river-sunset-valley-latvia.jpg', cap:'The Gauja valley at sunset'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-castle-reflection-water-latvia.jpg', cap:'Cēsis Castle reflected in the winter pond'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/sigulda-barefoot-baltic-van-winter-latvia.jpg', cap:'The Barefoot Baltic van in winter'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/gauja-river-misty-dawn-autumn-latvia.jpg', cap:'The Gauja river at dawn with rising mist'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/sigulda-bobsleigh-track-autumn-latvia.jpg', cap:'The Sigulda Olympic bobsleigh track in autumn'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/vidzeme-windmill-stone-archway-latvia.jpg', cap:'A Vidzeme windmill seen through a stone archway'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/vidzeme-orthodox-church-blue-domes-latvia.jpg', cap:'A blue-domed orthodox church in the Vidzeme countryside'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-st-johns-church-spire-latvia.jpg', cap:'Cēsis St John\'s Church'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-castle-autumn-forest-latvia.jpg', cap:'A Vidzeme castle framed by autumn forest'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/gauja-valley-wooden-forest-stairs-latvia.jpg', cap:'Wooden forest stairs in the Gauja Valley'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/latvia-white-stork-nest-countryside.jpg', cap:'A Latvian white stork nest — the national bird'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/cesis-heritage-historic-photo-latvia.jpg', cap:'Cēsis heritage — a historic local photograph'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/sigulda-rapeseed-field-spring-latvia.jpg', cap:'A rapeseed field in bloom, spring in the Gauja valley'},
  {src:'https://barefootbaltic.com/images/exc-sigulda/turaida-castle-gateway-guest-latvia.jpg', cap:'A guest at the gateway of Turaida Castle'},
];
let lbCur = 0;
