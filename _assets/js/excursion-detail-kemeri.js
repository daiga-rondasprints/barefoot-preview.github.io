...
const lbPhotos = [
  {src:'/images/exc-kemeri/kemeri-bog-aerial-autumn-alt-latvia.jpg', cap:'Aerial view of the bog in autumn'},
  {src:'/images/exc-kemeri/kemeri-bog-aerial-autumn-latvia.jpg', cap:'Autumn colours across the Ķemeri raised bog'},
  {src:'/images/exc-kemeri/kemeri-bog-aerial-from-tower-summer-latvia.jpg', cap:'View from the Ķemeri observation tower'},
  {src:'/images/exc-kemeri/kemeri-bog-aerial-spring-latvia.jpg', cap:'The Great Ķemeri Bog from above in spring'},
  {src:'/images/exc-kemeri/kemeri-bog-aerial-summer-latvia.jpg', cap:'Walkers on the bog boardwalk in summer light'},
  {src:'/images/exc-kemeri/kemeri-bog-walker-latvia.jpg', cap:'A guest pausing on the boardwalk in soft morning light'},
  {src:'/images/exc-kemeri/kemeri-bog-sunset-pine-closeup-latvia.jpg', cap:'Last light on a single bog pine'},
  {src:'/images/exc-kemeri/kemeri-bog-sunset-pine-glow-latvia.jpg', cap:'Pine trees glowing in the evening light'},
  {src:'/images/exc-kemeri/kemeri-bog-sunset-pines-latvia.jpg', cap:'Sunset over the dwarf pines of Ķemeri'},
  {src:'/images/exc-kemeri/kemeri-bog-sunset-pink-clouds-latvia.jpg', cap:'Pink clouds reflected in the dark bog pools'},
  {src:'/images/exc-kemeri/kemeri-bog-sunset-pond-latvia.jpg', cap:'A bog pool at golden hour'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-couple-portrait-latvia.jpg', cap:'A couple ready for the bog shoe walk'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-forest-trail-latvia.jpg', cap:'Heading back through the forest trail'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-group-listening-latvia.jpg', cap:'Learning about the moss underfoot'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-group-pond-edge-latvia.jpg', cap:'Pausing at the edge of a bog pool'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-group-pond-latvia.jpg', cap:'Walking together past a bog pool'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-group-portrait-latvia.jpg', cap:'Our group kitted up in bog shoes'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-pond-edge-latvia.jpg', cap:'A quiet bog pool seen from the moss'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-walker-pond-pink-latvia.jpg', cap:'Bog shoe walking beside a pink-lit pool'},
  {src:'/images/exc-kemeri/kemeri-bog-shoe-walker-solo-latvia.jpg', cap:'A guest in bog shoes off the boardwalk'},
  {src:'/images/exc-kemeri/kemeri-bog-watchtower-distant-latvia.jpg', cap:'The watchtower rising above the wetland'},
  {src:'/images/exc-kemeri/kemeri-watchtower-latvia.jpg', cap:'The Ķemeri bog observation tower'},
  {src:'/images/exc-kemeri/kemeri-poppies-latvia.jpg', cap:'Wildflowers in Ķemeri National Park'},
  {src:'/images/exc-kemeri/kemeri-rotunda-latvia.jpg', cap:'The Ķemeri sulphur spring rotunda'},
  {src:'/images/exc-kemeri/kemeri-sundew-latvia.jpg', cap:'Carnivorous sundew \u2014 the bog\u2019s tiny predator'},
  {src:'/images/exc-kemeri/jurmala-beach-pine-bench-latvia.jpg', cap:'A quiet bench among the pines'},
  {src:'/images/exc-kemeri/jurmala-beach-pines-latvia.jpg', cap:'Pine forest meeting the Jūrmala beach'},
  {src:'/images/exc-kemeri/kemeri-boardwalk-pond-latvia.jpg', cap:'The wooden boardwalk crossing a bog pool'},
  {src:'/images/exc-kemeri/kemeri-bog-bench-three-friends-latvia.jpg', cap:'Friends pausing on the boardwalk'},
  {src:'/images/exc-kemeri/kemeri-bog-boardwalk-selfie-latvia.jpg', cap:'A moment on the boardwalk'},
  {src:'/images/exc-kemeri/kemeri-bog-grasses-latvia.jpg', cap:'Cotton grass on the open bog'},
  {src:'/images/exc-kemeri/kemeri-bog-pond-from-tower-portrait-latvia.jpg', cap:'A bog pool seen from the tower'},
  {src:'/images/exc-kemeri/kemeri-bog-pond-summer-clouds-latvia.jpg', cap:'Clouds reflected in a summer bog pool'},
  {src:'/images/exc-kemeri/kemeri-forest-boardwalk-pines-latvia.jpg', cap:'The boardwalk winding through the pines'},
  {src:'/images/exc-kemeri/kemeri-forest-trail-group-selfie-latvia.jpg', cap:'A group on the forest trail'},
  {src:'/images/exc-kemeri/kemeri-info-board-raised-bog-latvia.jpg', cap:'Learning about the raised bog ecosystem'},
  {src:'/images/exc-kemeri/kemeri-info-board-rules-latvia.jpg', cap:'Park rules at the trailhead'},
  {src:'/images/exc-kemeri/kemeri-photographer-on-boardwalk-latvia.jpg', cap:'A photographer working the morning light'},
  {src:'/images/exc-kemeri/kemeri-pine-forest-trunks-latvia.jpg', cap:'Pine trunks in Ķemeri National Park'},
  {src:'/images/exc-kemeri/jurmala-beach-sunset-latvia.jpg', cap:'Golden sky over the Baltic at Jūrmala'},
  {src:'/images/exc-kemeri/jurmala-beach-swing-latvia.jpg', cap:'A beach swing at Jūrmala'},
  {src:'/images/exc-kemeri/jurmala-bicycle-sign-latvia.jpg', cap:'The Jūrmala beach pathway'},
  {src:'/images/exc-kemeri/jurmala-bike-rack-sunset-latvia.jpg', cap:'Bicycles at sunset, Jūrmala'},
  {src:'/images/exc-kemeri/jurmala-orthodox-church-latvia.jpg', cap:'The wooden Orthodox church in Jūrmala'},
  {src:'/images/exc-kemeri/jurmala-rocking-chair-latvia.jpg', cap:'A wooden rocking chair on a Jūrmala porch'},
  {src:'/images/exc-kemeri/jurmala-sign-sunset-latvia.jpg', cap:'The Jūrmala sign at golden hour'},
  {src:'/images/exc-kemeri/jurmala-sunset-picnic-latvia.jpg', cap:'A quiet evening on the Jūrmala coast'},
];
...
(function bbRandomise(){
  ...
  const heroPool = [
    {src:'/images/exc-kemeri/kemeri-bog-aerial-spring-latvia',  alt:'Aerial view of the Great Ķemeri Bog boardwalk winding past mirror-dark pools', credit:'iStock'},
    {src:'/images/exc-kemeri/kemeri-bog-aerial-summer-latvia',  alt:'Walkers on the Ķemeri bog boardwalk in summer light', credit:'Photo: Katrīna Eglīte / Unsplash'},
    {src:'/images/exc-kemeri/kemeri-bog-aerial-autumn-latvia',  alt:'Autumn colours across the Ķemeri raised bog', credit:'Photo: Liga Meijere / Unsplash'},
    {src:'/images/exc-kemeri/kemeri-bog-aerial-autumn-alt-latvia', alt:'Aerial view of the Ķemeri bog in autumn', credit:'Photo: Liga Meijere / Unsplash'},
    {src:'/images/exc-kemeri/kemeri-bog-aerial-from-tower-summer-latvia', alt:'View from the Ķemeri observation tower in summer', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-bog-sunset-pink-clouds-latvia', alt:'Pink clouds reflected in the dark waters of the Ķemeri bog', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-bog-sunset-pines-latvia', alt:'Sunset over the dwarf pines of Ķemeri', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-bog-sunset-pond-latvia', alt:'A bog pool at golden hour', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-bog-sunset-pine-glow-latvia', alt:'Pine trees glowing in the evening light', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-watchtower-latvia', alt:'The Ķemeri bog observation tower', credit:'Photo: Katrīna Eglīte / Unsplash'},
    {src:'/images/exc-kemeri/kemeri-bog-shoe-walker-pond-pink-latvia', alt:'A guest in bog shoes beside a pink-lit bog pool', credit:'© Barefoot Baltic'},
    {src:'/images/exc-kemeri/kemeri-boardwalk-pond-latvia', alt:'The wooden boardwalk crossing a bog pool', credit:'Photo: Marina Šurniene / Unsplash'},
  ];
