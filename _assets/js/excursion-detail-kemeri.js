...
var BK_PRICES = {
  0: { adult: 45, child: 35 }, // pay-later (base price)
  1: { adult: 45, child: 35 }, // bank transfer
  2: { adult: 46, child: 36 }, // Revolut (base + €1 fee passthrough)
  3: { adult: 47, child: 37 }  // Stripe (base + €2 fee passthrough)
};
...
var BK_I18N = {
  en: {
    ...
    'header.priceSub': 'per adult \u00a0\u00b7\u00a0 child \u20ac35',
...
var EXCURSION_NAME = 'Ķemeri Bog & Jūrmala';
var BOKUN_WORKER_URL = 'https://bokun-availability.daiga.workers.dev';
var BOKUN_ACTIVITY_ID = '1134921'; // TODO: replace with Ķemeri activity ID once created in Bókun
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  // Test-mode banner — only when ?test=1 is in the URL.
  if (bkIsTestMode()) {
...
async function bkCallPayLater(chipText) {
  ...
  var waMsg = 'Hi Daiga! I\u2019ve just reserved seats for the \u0136emeri Bog & J\u016Brmala tour \u2014 looking forward to it!\n\n'
...
function bkSendBankConfirmWA() {
  ...
  var msg = 'Hi Daiga!\n\nI have made a bank transfer for the \u0136emeri Bog & J\u016Brmala tour.\n\n'
    + 'Reference: ' + bkState.ref + '\n'
    + 'Date: ' + bkFormatDate(bkState.date) + '\n'
    + 'Adults: ' + bkState.adults + '\n'
    + (bkState.children > 0 ? 'Children: ' + bkState.children + '\n' : '')
  ...
  setTimeout(function() {
    window.location.href = '../thank-you.html'
      ...
      + '&exc=kemeri&adults=' + bkState.adults
      + '&children=' + bkState.children
      + '&total='    + total
      + '&method=bank'
...
function bkSendRevolutWA() {
  ...
  var msg = 'Hi Daiga!\n\nI\'d like to pay via Revolut for the \u0136emeri Bog & J\u016Brmala tour.\n\n'
    + 'Reference: ' + bkState.ref + '\n'
    + 'Date: ' + bkFormatDate(bkState.date) + '\n'
    + 'Adults: ' + bkState.adults + '\n'
    + (bkState.children > 0 ? 'Children: ' + bkState.children + '\n' : '')
...
function buildInquiryEmail() {
  return {
    subject: 'Question about Ķemeri Bog & Jūrmala tour',
    body: 'Hi Daiga,\n\nI\'m interested in the Ķemeri Bog & Jūrmala tour and have a few questions before booking.\n\n[Your questions here]\n\nThank you!'
  };
}
...
function buildBookingEmail() {
  ...
  return {
    subject: 'Revolut payment request — Ķemeri Bog & Jūrmala tour ' + fmtDate,
    body: 'Hi Daiga,\n\nI\'d like to pay via Revolut for the Ķemeri Bog & Jūrmala tour.\n\n'
      + 'Reference: ' + bkState.ref + '\n'
      + 'Date: ' + fmtDate + '\n'
      + 'Adults: ' + bkState.adults + '\n'
...
function bkFireConversion(method, value, ref) {
  if (typeof gtag !== 'undefined') {
    ...
    gtag('event', ev, {
      ...
      items: [{ item_id:'kemeri-bog-jurmala', item_name:'\u0136emeri Bog & J\u016Brmala',
...
const lbPhotos = [
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-autumn-alt-latvia.jpg', cap:'Aerial view of the bog in autumn'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-autumn-latvia.jpg', cap:'Autumn colours across the Ķemeri raised bog'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-from-tower-summer-latvia.jpg', cap:'View from the Ķemeri observation tower'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-spring-latvia.jpg', cap:'The Great Ķemeri Bog from above in spring'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-summer-latvia.jpg', cap:'Walkers on the bog boardwalk in summer light'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-walker-latvia.jpg', cap:'A guest pausing on the boardwalk in soft morning light'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pine-closeup-latvia.jpg', cap:'Last light on a single bog pine'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pine-glow-latvia.jpg', cap:'Pine trees glowing in the evening light'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pines-latvia.jpg', cap:'Sunset over the dwarf pines of Ķemeri'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pink-clouds-latvia.jpg', cap:'Pink clouds reflected in the dark bog pools'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pond-latvia.jpg', cap:'A bog pool at golden hour'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-couple-portrait-latvia.jpg', cap:'A couple ready for the bog shoe walk'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-forest-trail-latvia.jpg', cap:'Heading back through the forest trail'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-group-listening-latvia.jpg', cap:'Learning about the moss underfoot'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-group-pond-edge-latvia.jpg', cap:'Pausing at the edge of a bog pool'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-group-pond-latvia.jpg', cap:'Walking together past a bog pool'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-group-portrait-latvia.jpg', cap:'Our group kitted up in bog shoes'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-pond-edge-latvia.jpg', cap:'A quiet bog pool seen from the moss'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-walker-pond-pink-latvia.jpg', cap:'Bog shoe walking beside a pink-lit pool'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-walker-solo-latvia.jpg', cap:'A guest in bog shoes off the boardwalk'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-watchtower-distant-latvia.jpg', cap:'The watchtower rising above the wetland'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-watchtower-latvia.jpg', cap:'The Ķemeri bog observation tower'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-poppies-latvia.jpg', cap:'Wildflowers in Ķemeri National Park'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-rotunda-latvia.jpg', cap:'The Ķemeri sulphur spring rotunda'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-sundew-latvia.jpg', cap:'Carnivorous sundew \u2014 the bog\u2019s tiny predator'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-beach-pine-bench-latvia.jpg', cap:'A quiet bench among the pines'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-beach-pines-latvia.jpg', cap:'Pine forest meeting the Jūrmala beach'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-boardwalk-pond-latvia.jpg', cap:'The wooden boardwalk crossing a bog pool'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-bench-three-friends-latvia.jpg', cap:'Friends pausing on the boardwalk'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-boardwalk-selfie-latvia.jpg', cap:'A moment on the boardwalk'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-grasses-latvia.jpg', cap:'Cotton grass on the open bog'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-pond-from-tower-portrait-latvia.jpg', cap:'A bog pool seen from the tower'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-pond-summer-clouds-latvia.jpg', cap:'Clouds reflected in a summer bog pool'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-forest-boardwalk-pines-latvia.jpg', cap:'The boardwalk winding through the pines'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-forest-trail-group-selfie-latvia.jpg', cap:'A group on the forest trail'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-info-board-raised-bog-latvia.jpg', cap:'Learning about the raised bog ecosystem'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-info-board-rules-latvia.jpg', cap:'Park rules at the trailhead'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-photographer-on-boardwalk-latvia.jpg', cap:'A photographer working the morning light'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-pine-forest-trunks-latvia.jpg', cap:'Pine trunks in Ķemeri National Park'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-beach-sunset-latvia.jpg', cap:'Golden sky over the Baltic at Jūrmala'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-beach-swing-latvia.jpg', cap:'A beach swing at Jūrmala'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-bicycle-sign-latvia.jpg', cap:'The Jūrmala beach pathway'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-bike-rack-sunset-latvia.jpg', cap:'Bicycles at sunset, Jūrmala'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-orthodox-church-latvia.jpg', cap:'The wooden Orthodox church in Jūrmala'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-rocking-chair-latvia.jpg', cap:'A wooden rocking chair on a Jūrmala porch'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-sign-sunset-latvia.jpg', cap:'The Jūrmala sign at golden hour'},
  {src:'https://barefootbaltic.com/images/exc-kemeri/jurmala-sunset-picnic-latvia.jpg', cap:'A quiet evening on the Jūrmala coast'},
];

// ── BB: Randomise hero & gallery on each page load ──
(function bbRandomise(){
  // Pools — landscape-oriented hero candidates (the wide aerial / sunset / watchtower shots)
  // and a "gallery candidates" pool that excludes nothing (any lbPhoto can appear in the grid).
  const heroPool = [
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-spring-latvia',  alt:'Aerial view of the Great Ķemeri Bog boardwalk winding past mirror-dark pools', credit:'iStock'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-summer-latvia',  alt:'Walkers on the Ķemeri bog boardwalk in summer light', credit:'Photo: Katrīna Eglīte / Unsplash'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-autumn-latvia',  alt:'Autumn colours across the Ķemeri raised bog', credit:'Photo: Liga Meijere / Unsplash'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-autumn-alt-latvia', alt:'Aerial view of the Ķemeri bog in autumn', credit:'Photo: Liga Meijere / Unsplash'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-aerial-from-tower-summer-latvia', alt:'View from the Ķemeri observation tower in summer', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pink-clouds-latvia', alt:'Pink clouds reflected in the dark waters of the Ķemeri bog', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pines-latvia', alt:'Sunset over the dwarf pines of Ķemeri', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pond-latvia', alt:'A bog pool at golden hour', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-sunset-pine-glow-latvia', alt:'Pine trees glowing in the evening light', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-watchtower-latvia', alt:'The Ķemeri bog observation tower', credit:'Photo: Katrīna Eglīte / Unsplash'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-bog-shoe-walker-pond-pink-latvia', alt:'A guest in bog shoes beside a pink-lit bog pool', credit:'© Barefoot Baltic'},
    {src:'https://barefootbaltic.com/images/exc-kemeri/kemeri-boardwalk-pond-latvia', alt:'The wooden boardwalk crossing a bog pool', credit:'Photo: Marina Šurniene / Unsplash'},
  ];
  ...
  // ── Hero: pick 3 random images from the heroPool and write them into the 3 hero slots ──
  try {
    const heroPicks = shuffle(heroPool).slice(0, 3);
    document.querySelectorAll('.hero-slide').forEach((slide, i) => {
      const pick = heroPicks[i];
      if (!pick) return;
      const source = slide.querySelector('source');
      const img    = slide.querySelector('img');
      if (source) source.setAttribute('srcset', pick.src + '.webp');
      if (img) {
        img.setAttribute('src', pick.src + '.jpg');
        img.setAttribute('alt', pick.alt);
      }
      slide.setAttribute('data-credit', pick.credit || '');
    });
    // Set the initial credit overlay text from the first (active) slide
    const creditEl = document.getElementById('heroPhotoCredit');
    if (creditEl && heroPicks[0]) creditEl.textContent = heroPicks[0].credit || '';
  } catch(e) { console.warn('hero randomise:', e); }

  // ── Lightbox: shuffle the lbPhotos array IN PLACE so it opens to a different photo each visit ──
  try {
    if (Array.isArray(lbPhotos) && lbPhotos.length > 1) {
      const shuffled = shuffle(lbPhotos);
      lbPhotos.length = 0;
      shuffled.forEach(p => lbPhotos.push(p));
    }
  } catch(e) { console.warn('lightbox shuffle:', e); }

  // ── Gallery: pick 5 random photos from the (now-shuffled) lbPhotos and write them into the tiles ──
  try {
    const slots = document.querySelectorAll('[data-gallery-slot]');
    if (slots.length && Array.isArray(lbPhotos) && lbPhotos.length >= slots.length) {
      // Take the first N from the shuffled lbPhotos so the lightbox + gallery are consistent
      slots.forEach((slot, i) => {
        const photo = lbPhotos[i];
        if (!photo) return;
        const source = slot.querySelector('source');
        const img    = slot.querySelector('img');
        const jpgPath = photo.src;                       // already a .jpg path
        const webpPath = jpgPath.replace(/\.jpg$/, '.webp');
        if (source) source.setAttribute('srcset', webpPath);
        if (img) {
          img.setAttribute('src', jpgPath);
          // Strip HTML entities from caption for the alt text
          const cleanCap = photo.cap.replace(/&[a-z#0-9]+;/gi, '').replace(/<[^>]+>/g, '');
          img.setAttribute('alt', cleanCap);
        }
      });
    }
  } catch(e) { console.warn('gallery randomise:', e); }
})();
